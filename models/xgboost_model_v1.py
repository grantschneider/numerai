...
training_df_limited_era = _subset_training_data_by_era(
  training_df = full_training_df, era_numeric = 100
)

training_data_X_100_eras, training_data_Y_100_eras = _construct_X_and_Y_for_training(
  training_df = training_df_limited_era, target_name = TARGET_NAME
)


X_train, X_test, y_train, y_test = train_test_split(
  training_data_X_100_eras,
  training_data_Y_100_eras,
  test_size=0.2,
  random_state=0
)
